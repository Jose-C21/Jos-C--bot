...
// 2. Si el mensaje menciona o responde a alguien AFK → avisar en el grupo.
//
...
// Quita el device suffix para comparar JIDs correctamente (@lid, @s.whatsapp.net)
...
// Extrae el JID del autor del mensaje al que se responde (reply/quote)
...
export async function afkWatcher(sock, msg) {
  try {
    ...
    // ─────────────────────────────────────────────────────
    // 1. ¿El que escribe está AFK? → quitar y avisar vuelta
    // ─────────────────────────────────────────────────────
    let volvioDe = null
