...
export default async function menu(sock, msg) {
  try {
    ...
    switch (diaSemana.toLowerCase()) {
      ...
      case "martes": msgDia = "🚀 ᴍᴀʳᴛᴇꜱ ᴅᴇ ᴇɴᴇʀɢɪᴀ ᴘᴏꜱɪᴛɪᴠᴀ"; break
      case "miércoles": msgDia = "🌟 ᴍɪᴛᴀᴅ ᴅᴇ ꜱᴇᴍᴀɴᴀ, ꜱɪɢᴜᴇ ꜰᴜᴇʳᴛᴇ"; break
      case "jueves": msgDia = "🔥 ¡ᴄᴀꜱɪ ᴠɪᴇʳɴᴇꜱ, ɴᴏ ᴛᴇ ʀɪɴᴅᴀꜱ!"; break
      case "viernes": msgDia = "🎉 ᴠɪᴇʳɴᴇꜱ ᴀʟ ꜰɪɴ, ᴅɪꜱꜰʀᴜᴛᴀ ᴛᴜ ᴅɪᴀ"; break
      case "sábado": msgDia = "😎 ꜱᴀʙᴀᴅᴏ ʳᴇʟᴀx, ᴘᴇʀᴏ ᴅɪᴠᴇʀᴛɪᴅᴏ"; break
      case "domingo": msgDia = "☀️ ᴅᴏᴍɪɴɢᴏ ᴛʳᴀɴQᴜɪʟᴏ, ʳᴇᴄᴀʀɢᴀ ᴇɴᴇʳɢɪᴀꜱ"; break
      default: msgDia = ""
    }
