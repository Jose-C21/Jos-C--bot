...
export default async function menu(sock, msg) {
  try {
    ...
    switch (diaSemana.toLowerCase()) {
      ...
      case "sábado": msgDia = "😎 ꜱᴀʙᴀᴅᴏ ʳᴇʟᴀx, ᴘᴇʳᴏ ᴅɪᴠᴇʳᴛɪᴅᴏ"; break
      case "domingo": msgDia = "☀️ ᴅᴏᴍɪɴɢᴏ ᴛʳᴀɴQᴜɪʟᴏ, ʳᴇᴄᴀʳɢᴀ ᴇɴᴇʳɢɪᴀꜱ"; break
      default: msgDia = ""
    }
    ...
    if (isOwner) rol = "🧩 ᴅᴇᴠᴇʟᴏᴘᴇʳ"
    else if (isAdmin) rol = "👑 ᴀᴅᴍɪɴɪꜱᴛʳᴀᴅᴏʳ"

    const rolImagen = isOwner ? "DEVELOPER" : isAdmin ? "ADMINISTRADOR" : "USUARIO"

    const tipoChat = String(chatId).endsWith("@g.us") ? "👥 ɢʳᴜᴘᴏ" : "💬 ᴘʳɪᴠᴀᴅᴏ"
    ...
    try {
      ...
      else if (msgId.startsWith("e")) { dispositivo = "🤖 ᴀɴᴅʳᴏɪᴅ"; dispositivoImagen = "Android" }
      else { dispositivo = "🤖 ᴀɴᴅʳᴏɪᴅ"; dispositivoImagen = "Android" }
    } catch {
...
> ➤ .𝘁𝗶𝗸𝘁𝗼𝗸 ⇾ ᴅᴇꜱᴄᴀʳɢᴀʳ ᴠɪᴅᴇᴏ ᴛɪᴋᴛᴏᴋ
> ➤ .𝗱𝗲𝘁𝗲𝗰𝘁𝗮𝗿 ⇾ ʳᴇᴄᴏɴᴏᴄᴇ ᴄᴀɴᴄɪᴏ́ɴ
...
❑ 𝗚𝗿𝘂𝗽𝗼 — 𝗣𝘂́𝗯𝗹𝗶𝗰𝗼
> ➤ .𝗽𝗲𝗿𝗳𝗶𝗹 ⇾ ꜰᴏᴛᴏ ᴅᴇ ᴘᴇʳꜰɪʟ
> ➤ .𝗴𝗼𝗹𝗽𝗲𝗮𝗿 ⇾ ɢᴏʟᴘᴇᴀʳ ᴜꜱᴜᴀʳɪᴏ
> ➤ .𝗸𝗶𝘀𝘀 ⇾ ᴅᴀʳ ᴜɴ ʙᴇꜱᴏ
> ➤ .𝗿𝗲𝗽𝗼𝗿𝘁𝗮𝗿 ⇾ ᴅᴇɴᴜɴᴄɪᴀ ᴀ ᴜɴ ᴜꜱᴜᴀʳɪᴏ ʏ ɴᴏᴛɪꜰɪᴄᴀ ᴀ ᴛᴏᴅᴏꜱ ʟᴏꜱ ᴀᴅᴍɪɴꜱ ᴄᴏɴ ᴇʟ ᴍᴏᴛɪᴠᴏ ᴘᴀʳᴀ ǫᴜᴇ ᴀᴄᴛᴜ́ᴇɴ ʳᴀ́ᴘɪᴅᴏ

❑ 𝗚𝗿𝘂𝗽𝗼 — 𝗔𝗱𝗺𝗶𝗻𝘀
> ➤ .𝘁𝗮𝗴 ⇾ ᴍᴇɴᴄɪᴏɴᴀʳ ᴀ ᴛᴏᴅᴏꜱ
> ➤ .𝘃𝗲𝗿 ⇾ ʳᴇᴄᴜᴘᴇʳᴀʳ ᴠɪꜱᴛᴀ ᴜ́ɴɪᴄᴀ
> ➤ .𝗮𝗱𝗱 ⇾ ᴀɢʳᴇɢᴀʳ ᴜꜱᴜᴀʳɪᴏ
> ➤ .𝗸𝗶𝗰𝗸/.𝗯𝗮𝗻 ⇾ ᴇxᴘᴜʳꜱᴀʳ ᴜꜱᴜᴀʳɪᴏ
> ➤ .𝗺𝘂𝘁𝗲/.𝘂𝗻𝗺𝘂𝘁𝗲 ⇾ ᴍᴜᴛᴇᴀʳ ᴜꜱᴜᴀʳɪᴏ
> ➤ .𝗳𝗮𝗻𝘁𝗮𝘀𝗺𝗮𝘀 ⇾ ᴍɪᴇᴍʙʳᴏꜱ ɪɴᴀᴄᴛɪᴠᴏꜱ
> ➤ .𝗳𝗮𝗻𝗸𝗶𝗰𝗸 ⇾ ᴇxᴘᴜʳꜱᴀ ꜰᴀɴᴛᴀꜱᴍᴀꜱ
> ➤ .𝗼𝗽𝗲𝗻/.𝗰𝗹𝗼𝘀𝗲 ⇾ ᴀʙʳɪʳ/ᴄᴇʳʳᴀʳ ɢʳᴜᴘᴏ

❑ 𝗠𝗼𝗱𝗲𝗿𝗮𝗰𝗶𝗼́𝗻 (𝗼𝗻/𝗼𝗳𝗳) — 𝗔𝗱𝗺𝗶𝗻𝘀
> ➤ .𝗮𝗻𝘁𝗶𝗹𝗶𝗻𝗸 ⇾ ʙʟᴏǫᴜᴇᴀ ʟɪɴᴋꜱ
> ➤ .𝗮𝗻𝘁𝗶𝘀 ⇾ ᴀɴᴛɪꜱᴘᴀᴍ ꜱᴛɪᴄᴋᴇʳꜱ
> ➤ .𝗮𝗻𝘁𝗶𝗮𝗿𝗮𝗯𝗲 ⇾ ʙʟᴏǫᴜᴇᴀ ɴᴜ́ᴍᴇʳᴏꜱ ᴀ́ʳᴀʙᴇꜱ
> ➤ .𝗮𝗻𝘁𝗶𝗽𝗲𝗿𝘀𝗼𝗻𝗮 ⇾ ᴀʟᴇʳᴛᴀ ᴄᴀᴍʙɪᴏ ᴅᴇ ɴᴏᴍʙʳᴇ
...
❑ 𝗔𝗱𝘃𝗲𝗿𝘁𝗲𝗻𝗰𝗶𝗮𝘀 — 𝗔𝗱𝗺𝗶𝗻𝘀
> ➤ .𝘄𝗮𝗿𝗻 ⇾ ᴅᴀʳ ᴀᴅᴠᴇʳᴛᴇɴᴄɪᴀ
> ➤ .𝘄𝗮𝗿𝗻𝘀 ⇾ ᴠᴇʳ ᴀᴅᴠᴇʳᴛᴇɴᴄɪᴀꜱ
> ➤ .𝘂𝗻𝘄𝗮𝗿𝗻 ⇾ ǫᴜɪᴛᴀʳ ᴀᴅᴠᴇʳᴛᴇɴᴄɪᴀ
> ➤ .𝗿𝗲𝘀𝗲𝘁𝘄𝗮𝗿𝗻𝘀 ⇾ ʙᴏʳʳᴀʳ ᴛᴏᴅᴀꜱ

❑ 𝗖𝗼𝗻𝘁𝗲𝗼 𝘆 𝗹𝗶𝘀𝘁𝗮𝘀 — 𝗣𝘂́𝗯𝗹𝗶𝗰𝗼
> ➤ .𝘁𝗼𝘁𝗮𝗹𝗺𝗲𝗻𝘀𝗮𝗷𝗲𝘀 ⇾ ᴄᴏɴᴛᴇᴏ ᴅᴇ ᴍᴇɴꜱᴀᴊᴇꜱ
> ➤ .𝗲𝘀𝘁𝗮𝗱𝗼𝗰𝗼𝗻𝘁𝗲𝗼 ⇾ ᴠᴇʳ ᴇꜱᴛᴀᴅᴏ

❑ 𝗖𝗼𝗻𝘁𝗲𝗼 𝘆 𝗹𝗶𝘀𝘁𝗮𝘀 — 𝗢𝘄𝗻𝗲𝗿
> ➤ .𝗮𝗱𝗱𝗹𝗶𝘀𝘁𝗮 ⇾ ᴀɢʳᴇɢᴀʳ ᴀ ʟɪꜱᴛᴀ
> ➤ .𝗽𝗮𝘂𝘀𝗮𝗿𝗰𝗼𝗻𝘁𝗲𝗼 ⇾ ᴘᴀᴜꜱᴀʳ ᴄᴏɴᴛᴇᴏ
